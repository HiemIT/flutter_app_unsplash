class LangCode {
  ...
  //
  //collections
  static const String subCollections = "sub-collections";
  //
  //topics
  ...
  static const String subSearch = "sub-search";
  //
  //photo detail
  static const String camera = "camera";
  static const String aperture = "aperture";
  static const String focalLength = "focal-length";
  static const String shutterSpeed = "shutter-speed";
  ...
  static const String downloadErr = "download-err";
  ...
  static const String subNotificationAddAccount =
      "sub-notification-add-account";
